  ...
  return (
    <form onSubmit={handleUploadVideo} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Textarea disabled={status !== 'waiting'} ref={promptInputRef} id="transcription_prompt" className="h-20 resize-none leading-relaxed" placeholder="Inclua palavras-chave mencionadazx no video separadas por virgula (,)" />
      </div>
